...
ScreenGui.Name = "WhatsAppPromptGui_Final_Fixed"
...
---
-- FUNÇÕES E COMPORTAMENTOS (EXECUÇÃO DO SEU SCRIPT)
---

-- Função executada ao fechar (Carrega o RedzHub V2 diretamente)
local function carregarProximoScript()
    local success, err = pcall(function()
        -- Executa o RedzHub V2 hospedado no link do GitHub indicado
        loadstring(game:HttpGet("https://raw.githubusercontent.com/UCT-hub/main/refs/heads/main/redz-v2"))()
    end)
    if not success then
        warn("Erro ao carregar o RedzHub V2: " .. tostring(err))
    end
end
...
CloseButton.MouseButton1Click:Connect(function()
    ...
    carregarProximoScript() -- Carrega e abre o script do RedzHub V2
end)
